...
public sealed class ApiKeyConcernBuilder : IConcernBuilder
{
    ...
    private Func<IRequest, string?>? _keyExtractor = request => request.Headers.GetValue("X-API-Key");
    ...
    {
        _keyExtractor = request => request.Headers.GetValue(headerName);
        return this;
    }
    ...
    {
        _keyExtractor = request => request.Query.GetValue(parameter);
        return this;
    }
