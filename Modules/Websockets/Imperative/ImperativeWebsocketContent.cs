...
public sealed class ImperativeWebsocketContent(IImperativeHandler handler, IRequest request, int rxBufferSize, bool handleContinuationFramesManually) : IResponseContent
{
