...
public interface IReactiveHandler
{
    ...
    ValueTask OnMessage(IReactiveConnection connection, IWebsocketFrame message) =>  ValueTask.CompletedTask;
    ...
    ValueTask OnBinary(IReactiveConnection connection, IWebsocketFrame message) =>  ValueTask.CompletedTask;

    ValueTask OnContinue(IReactiveConnection connection, IWebsocketFrame message) =>  ValueTask.CompletedTask;
    ...
    ValueTask OnPing(IReactiveConnection connection, IWebsocketFrame message) => connection.PongAsync(message.Data);
    ...
    ValueTask OnPong(IReactiveConnection connection, IWebsocketFrame message) =>  ValueTask.CompletedTask;
    ...
    ValueTask OnClose(IReactiveConnection connection, IWebsocketFrame message) => connection.CloseAsync();
