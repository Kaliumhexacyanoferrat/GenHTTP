...
public class ReactiveWebsocketBuilder : IHandlerBuilder<ReactiveWebsocketBuilder>
{
    ...
    public ReactiveWebsocketBuilder OnConnected(Func<ReactiveWebsocketStream, ValueTask> onConnected)
    {
        _reactiveWebsocketContent.OnConnected = onConnected;
        return this;
    }
    
    public ReactiveWebsocketBuilder OnMessage(Func<ReactiveWebsocketStream, ValueTask> onMessage)
    {
        _reactiveWebsocketContent.OnMessage = onMessage;
        return this;
    }
    
    public ReactiveWebsocketBuilder OnBinary(Func<ReactiveWebsocketStream, ValueTask> onBinary)
    {
        _reactiveWebsocketContent.OnBinary = onBinary;
        return this;
    }
    
    public ReactiveWebsocketBuilder OnContinue(Func<ReactiveWebsocketStream, ValueTask> onContinue)
    {
        _reactiveWebsocketContent.OnContinue = onContinue;
        return this;
    }
    
    public ReactiveWebsocketBuilder OnPing(Func<ReactiveWebsocketStream, ValueTask> onPing)
    {
        _reactiveWebsocketContent.OnPing = onPing;
        return this;
    }
    
    public ReactiveWebsocketBuilder OnPong(Func<ReactiveWebsocketStream, ValueTask> onPong)
    {
        _reactiveWebsocketContent.OnPong = onPong;
        return this;
    }
    
    public ReactiveWebsocketBuilder OnClose(Func<ReactiveWebsocketStream, ValueTask> onClose)
    {
