...
namespace GenHTTP.Modules.IO
{
    ...
    public static class ChangeTracking
    {
        ...
        /// </remarks>
        public static ChangeTrackingResource WithChangeTracking(this IResource resource) => new ChangeTrackingResource(resource);
        ...
        /// or interpreting the content of the resource.
        /// </remarks>
        public static ChangeTrackingResource BuildWithChangeTracking(this IBuilder<IResource> resourceBuilder) => new ChangeTrackingResource(resourceBuilder.Build());
