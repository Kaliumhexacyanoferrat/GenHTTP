...
public static class Extensions
{
    ...
    /// Validates the cached entries of the client by sending an ETag header and evaluating it when
    /// a request is processed (returning HTTP 304 if the content did not change)
    /// </param>
