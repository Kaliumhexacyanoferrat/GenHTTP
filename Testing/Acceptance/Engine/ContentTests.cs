...
namespace GenHTTP.Testing.Acceptance.Engine
{
    ...
    public sealed class ContentTests
    {
        ...
        {
            using var runner = TestHost.Run(Listing.From(ResourceTree.FromAssembly("Resources"))
                                         .Add(new ContentPrinterBuilder()));
        ...
        {
            using var runner = TestHost.Run(SinglePageApplication.From(ResourceTree.FromAssembly("Resources"))
                                         .Add(new ContentPrinterBuilder()));
        ...
        {
            using var runner = TestHost.Run(WebsiteTests.GetWebsite().Add(new ContentPrinterBuilder()));
