...
namespace GenHTTP.Testing.Acceptance.Providers
{
    ...
    public class LoadBalancerTests
    {
        ...
        {
            using var upstream = TestRunner.Run(Content.FromString("Proxy!"));
        ...
        {
            var loadbalancer = LoadBalancer.Create()
                                           .Add(Content.FromString("My Content!"));
        ...
        {
            var loadbalancer = LoadBalancer.Create()
                                           .Add(Content.FromString("Prio A"), r => Priority.High)
                                           .Add(Content.FromString("Prio B"), r => Priority.Low);
        ...
        {
            var loadbalancer = LoadBalancer.Create()
                                           .Add(Content.FromString("Prio A1"), r => Priority.High)
                                           .Add(Content.FromString("Prio A2"), r => Priority.High)
                                           .Add(Content.FromString("Prio A3"), r => Priority.High);
