...
namespace GenHTTP.Api.Content
{
    ...
    public abstract class ParametrizedContentProvider : IContentProvider
    {
        ...
        /// </summary>
        public ParametrizedContentProvider(IServer server)
        {
        ...
        public void HandleRequest(IHttpRequest request, IHttpResponse response, AuthorizationInfo info)
        {
            ...
            {
                _Server.DefaultWrongParametersProvider.HandleRequest(request, response, info);
                return;
            }
            ...
            {
                _Server.DefaultNotEnoughRightsProvider.HandleRequest(request, response, info);
                return;
            }
        ...
        protected abstract void GenerateContent(IHttpRequest request, IHttpResponse response, AuthorizationInfo info, ParameterAnalysis analysis, bool hasPermission);
