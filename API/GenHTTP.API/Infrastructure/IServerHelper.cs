...
namespace GenHTTP.Api.Infrastructure
{
    ...
    public interface IServerHelper
    {
        ...
        void GenerateIndex(IHttpRequest request, IHttpResponse response);
        ...
        /// </remarks>
        void GenerateNotFound(IHttpRequest request, IHttpResponse response);
        ...
        void GenerateServerError(IHttpRequest request, IHttpResponse response, Exception exception);
        ...
        /// <param name="request">The request sent by the client</param>
        /// <param name="response">The response to write to</param>
        void GenerateNoContent(IHttpRequest request, IHttpResponse response);

        /// <summary>
        /// This method will be called whenever the client sends a malformed request. 
        /// </summary>
        /// <param name="response">The response to write to</param>
        void GenerateBadRequest(IHttpResponse response);
        ...
        bool GenerateOther(IHttpRequest request, IHttpResponse response);
