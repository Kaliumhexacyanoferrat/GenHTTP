...
namespace GenHTTP.Api.Caching
{
    ...
    public class ProjectCache
    {
        ...
        public ProjectCache(ProjectBase project)
        {
            _MaxSize = 1048576;
            _MaxEntries = 50;
            _CurrentSize = 0;
        ...
        public ProjectCache(ProjectBase project, long maxSize, uint maxEntries) : this(project)
        {
            _MaxSize = maxSize;
        ...
        public bool HandleRequest(IHttpRequest request, IHttpResponse response, AuthorizationInfo info)
        {
