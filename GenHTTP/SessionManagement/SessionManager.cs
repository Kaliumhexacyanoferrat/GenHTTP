...
namespace GenHTTP.SessionManagement {
  ...
  public class SessionManager {
    ...
    public AuthorizationInfo CheckSession(HttpRequest request, HttpResponse response) {
  ...
  public class AuthorizationInfo {
    ...
    /// <summary>
    /// The session assigned to the given <see cref="HttpRequest" />. If the value of this
