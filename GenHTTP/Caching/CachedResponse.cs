...
namespace GenHTTP.Caching {
  ...
  public class CachedResponse {
    ...
    /// </remarks>
    public CachedResponse(HttpResponse headerSource, byte[] data, CheckApplicability check) {
      _Data = data;
    ...
    /// entry will be sent without a applicability check.
    /// </remarks>
    public CachedResponse(HttpResponse headerSource, byte[] data, CheckApplicability check, ushort ttl, ushort htl) : this(headerSource, data, check) {
      _TTL = ttl;
      _HTL = htl;
    }
    ...
    public bool IsApplicable(HttpRequest request, AuthorizationInfo info) {
