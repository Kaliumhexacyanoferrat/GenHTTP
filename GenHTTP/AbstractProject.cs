...
namespace GenHTTP {
  ...
  public abstract class AbstractProject : IProject {
    ...
    private ProjectColorCollection _Colors;
    ...
    public AbstractProject() {
      ...
      _Colors = new ProjectColorCollection();
    }
    ...
    public virtual void Init(Server server, string localFolder, Log log) {
      _Server = server;
      ...
      _NotFoundProvider = new DefaultNotFoundProvider(server);
      _NotLoggedInProvider = new DefaultNotLoggedInProvider(server);
      _NotEnoughRightsProvider = new DefaultNotEnoughRightsProvider(server);
    ...
    /// <summary>
    /// Retrieve the project specific colors.
    /// </summary>
    public ProjectColorCollection Colors {
      get { return _Colors; }
    }
    ...
    public abstract void PreHandleRequest(HttpRequest request, HttpResponse response);
