...
namespace GenHTTP {
  ...
  /// </summary>
  /// <remarks>
  /// Should be identical with <see cref="IPageStyle.Encoding"/>. This list
  /// follows the W3C specification used for character encodins.
  /// </remarks>
  ...
  /// <summary>
  /// Style information about the web page stored in the (X)HTML header.
  /// </summary>
  public interface IHeaderStyle {

    /// <summary>
    /// The encoding used for the web page.
    /// </summary>
    HtmlEncoding HtmlEncoding { get; set; }
